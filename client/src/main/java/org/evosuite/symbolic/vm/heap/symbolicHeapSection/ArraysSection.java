 ...
 *
 * <p>TODO: In the future we can do an implementation similar to the VMs, a general symbolicHeap with all the methods
 * and an implementation of each section (e.g. AbstractSymbolicHeap -> ArraysHeap -> ReferencesHeap -> etc...</p>
 *
...
public interface ArraysSection {
     ...
     *
     * @param concreteArray the concrete array instance
     * @param instanceId the instance id
     * @param name the variable name
     * @return the created array variable
     */
     ...
     * @param instanceId the instance id
     * @return the created array constant
     */
     ...
     * @param symbolicIndex Symbolic element of the accessed index
     * @param symbolicValue Symbolic element of the accessed value
     * @return the loaded reference expression
     */
    ReferenceExpression arrayLoad(ReferenceExpression symbolicArray, IntegerValue symbolicIndex,
     ...
     * @param symbolicValue Symbolic element of the accessed value
     */
    void arrayStore(Object concreteArray, ReferenceExpression symbolicArray, IntegerValue symbolicIndex,
