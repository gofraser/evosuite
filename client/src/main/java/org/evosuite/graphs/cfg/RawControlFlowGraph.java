 ...
 * instruction the control flow can reach immediately after that instruction.</p>
 *
 * @author Andre Mis
 */
public class RawControlFlowGraph extends ControlFlowGraph<BytecodeInstruction> {
    ...
    private boolean isNonJumpingEdge(BytecodeInstruction src,
                                     // TODO move to ControlFlowGraph and implement analog method in ActualCFG
