...
public class JavaExecCmdUtilUnixTest {
    ...
    @Test
    public void unixFallbackToJavaWhenFullPathNotRequiredAndEnvPathUnavailable() {
        ...
        try {
            ...
            System.setProperty("java.home", "/tmp/evosuite-java-home-unix");

            String expected = expectedPath(false, Optional.of("Mac OS X"), "/", "/tmp/evosuite-java-home-unix");
    ...
    @Test
    public void unixFallbackToJavaCmdWhenFullPathRequiredAndEnvPathUnavailable() {
        String originalOs = System.getProperty("os.name");
        String originalSep = System.getProperty("file.separator");
        String originalJavaHome = System.getProperty("java.home");
        try {
            ...
            String expected = expectedPath(true, Optional.of("Mac OS X"), "/", "/tmp/evosuite-java-home-unix");
