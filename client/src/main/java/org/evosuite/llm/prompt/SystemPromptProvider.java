...
public class SystemPromptProvider {
    ...
    public String getSystemPrompt() {
        ...
        String structuralDirectives = " IMPORTANT: Each @Test method MUST be completely self-contained. "
                ...
                + "STRICT CONSTRAINT: You MUST ONLY use constructors and methods that are explicitly listed in the 'CLASS UNDER TEST' or 'Available dependency types' sections. "
                + "Do NOT assume a class has a default constructor if it is not listed. "
                + "Do NOT assume a class has a constructor with arguments if only a default one is listed. "
