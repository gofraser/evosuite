 ...
 * constructor, etc.
 *
 * <p><b>IMPORTANT</b>: each OverrideMock implementation should handle rollback to non-mocked functionality.
 ...
 * of an instrumented class based on flag. Eg: "class Foo extends File" will be replaced by
 * "class Foo extends MockFile", and we cannot change it back afterwards.
 *
 * @author arcuri
 *
 */
