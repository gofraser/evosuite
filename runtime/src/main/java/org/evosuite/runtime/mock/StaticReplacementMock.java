 ...
 *
 * <p>On one hand, static methods of the mocked class will be replaced directly.
 *
 * <p>On the other hand, instance methods will be replaced by static ones that take
 ...
 *
 * <p>Furthermore, in case of public constructors, the mock should provide a static
 ...
 *
 * <p>{@code public Foo(int x) {...}}
 *
 * <p>should be mocked into:
 *
 * <p>{@code public static Foo Foo(int x) {...}}
 *
 * <p>This type of mock is particularly useful for singleton classes that cannot be
