...
public class TargetClassInitializer {
     ...
     * @param onInitializationError A runnable to execute if an initialization error occurs (e.g.,
     *                              writing a failed test suite).
    ...
    /**
     * Returns true if the test case execution has thrown an instance of ExceptionInInitializerError.
     *
