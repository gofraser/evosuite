...
import org.evosuite.symbolic.dse.algorithm.strategies.implementations.pathextension.ExpandExecutionStrategy;
...
public class SAGEExplorationAlgorithm extends ExplorationAlgorithm {
     ...
     *
     * @return the priority queue for work list.
     */
    @Override
     ...
     * test Suite.
     *
     * <p>In case the current {@link org.evosuite.testcase.TestCase} diverged, its score is automatically 0.
     *
     * @param newTestCase the new test case to score.
     * @param hasPathConditionDiverged true if path condition diverged.
     * @return the test case score.
     */
    @Override
