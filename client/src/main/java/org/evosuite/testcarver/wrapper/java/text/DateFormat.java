...
public abstract class DateFormat extends java.text.DateFormat {
    ...
    public final StringBuffer format_final(Object obj, StringBuffer toAppendTo,
        ...
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "format",
                "(Ljava/lang/Object;Ljava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;",
                new Object[]{obj, toAppendTo, fieldPosition});
    ...
    public final String format_final(java.util.Date date) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "format",
                "(Ljava/util/Date;)Ljava/lang/String;", new Object[]{date});
    ...
    public java.util.Date parse(String source) throws ParseException {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "parse",
                "(Ljava/lang/String;)Ljava/lang/Object;", new Object[]{source});
    ...
    public Object parseObject(String source, ParsePosition pos) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "parse",
                "(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/lang/Object;", new Object[]{source, pos});
    ...
    /**
     * Shadow of getTimeInstance method.
     *
    ...
    public static java.text.DateFormat getTimeInstance_final() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getTimeInstance", "()Ljava/text/DateFormat;", new Object[]{});
        java.text.DateFormat ret = java.text.DateFormat.getTimeInstance();
        FieldRegistry.register(ret);
        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT,
                CaptureUtil.loadClass("java/text/DateFormat"), ret);
        return ret;
    }
    ...
    public static java.text.DateFormat getTimeInstance_final(int style) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getTimeInstance", "(I)Ljava/text/DateFormat;", new Object[]{style});
    ...
    public static java.text.DateFormat getTimeInstance_final(int style,
                                                             Locale locale) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getTimeInstance", "(ILjava/util/Locale;)Ljava/text/DateFormat;", new Object[]{style, locale});
        java.text.DateFormat ret = java.text.DateFormat.getTimeInstance(style, locale);
        FieldRegistry.register(ret);
        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT,
                CaptureUtil.loadClass("java/text/DateFormat"), ret);
        return ret;
    ...
    /**
     * Shadow of getDateInstance method.
     *
     * @return a DateFormat instance
     */
    // TODO: This needs to create an instance of the wrapper class, which it currently doesn't do!
    public static java.text.DateFormat getDateInstance_final() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateInstance", "()Ljava/text/DateFormat;", new Object[]{});
    ...
    public static java.text.DateFormat getDateInstance_final(int style) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateInstance", "(I)Ljava/text/DateFormat;", new Object[]{style});
    ...
    public static java.text.DateFormat getDateInstance_final(int style,
                                                             Locale locale) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateInstance", "(ILjava/util/Locale;)Ljava/text/DateFormat;", new Object[]{style, locale});
        java.text.DateFormat ret = java.text.DateFormat.getDateInstance(style, locale);
        FieldRegistry.register(ret);
        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT,
                CaptureUtil.loadClass("java/text/DateFormat"), ret);
        return ret;
    ...
    /**
     * Shadow of getDateTimeInstance method.
     *
     * @return a DateFormat instance
     */
    // TODO: This needs to create an instance of the wrapper class, which it currently doesn't do!
    public static java.text.DateFormat getDateTimeInstance_final() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateTimeInstance", "()Ljava/text/DateFormat;", new Object[]{});
        java.text.DateFormat ret = java.text.DateFormat.getDateTimeInstance();
        FieldRegistry.register(ret);
        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT,
                CaptureUtil.loadClass("java/text/DateFormat"), ret);
        return ret;
    ...
    public static java.text.DateFormat getDateTimeInstance_final(int dateStyle,
                                                                 int timeStyle) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateTimeInstance", "(II)Ljava/text/DateFormat;", new Object[]{dateStyle, timeStyle});
     ...
     */
    // TODO: This needs to create an instance of the wrapper class, which it currently doesn't do!
    public static java.text.DateFormat getDateTimeInstance_final(int dateStyle, int timeStyle, Locale locale) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getDateTimeInstance", "(IILjava/util/Locale;)Ljava/text/DateFormat;",
                new Object[]{dateStyle, timeStyle, locale});
        java.text.DateFormat ret = java.text.DateFormat.getDateTimeInstance(dateStyle, timeStyle, locale);
        FieldRegistry.register(ret);
        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT,
                CaptureUtil.loadClass("java/text/DateFormat"), ret);
        return ret;
    ...
    public static java.text.DateFormat getInstance_final() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, CaptureUtil.loadClass("java/text/DateFormat"),
                "getInstance", "()Ljava/text/DateFormat;", new Object[]{});
    ...
    /**
     * Static wrapper for getAvailableLocales.
     *
    ...
    public void setCalendar(java.util.Calendar newCalendar) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "setCalendar", "(Ljava/util/Calendar;)V",
    ...
    public java.util.Calendar getCalendar() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "getCalendar", "()Ljava/util/Calendar;",
                new Object[]{});
    ...
    public void setNumberFormat(NumberFormat newNumberFormat) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "setNumberFormat",
                "(Ljava/text/NumberFormat;)V", new Object[]{newNumberFormat});
    ...
    public NumberFormat getNumberFormat() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "getNumberFormat",
                "()Ljava/text/NumberFormat;", new Object[]{});
    ...
    public void setTimeZone(TimeZone zone) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "setTimeZone", "(Ljava/util/TimeZone;",
                new Object[]{zone});
    ...
    public TimeZone getTimeZone() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "getTimeZone", "()Ljava/util/TimeZone;",
                new Object[]{});
    ...
    public void setLenient(boolean lenient) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "setLenient", "(Z)V",
                new Object[]{lenient});
    ...
    public boolean equals(Object obj) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "equals", "(Ljava/lang/Object;)Z",
                new Object[]{obj});
    ...
    @Override
    public Object clone() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_TEXT_DATEFORMAT, this, "clone", "()Ljava/lang/Object;",
                new Object[]{});
