...
public class Calendar extends java.util.Calendar {
    ...
    /**
     * Constructs a new Calendar wrapper.
     *
     * @param cal the calendar to wrap
     */
    ...
    /**
     * Static wrapper for getTime.
     *
     * @param cal the calendar to get time from
     * @return the time as a Date
     */
    ...
    /**
     * Static wrapper for getInstance.
     *
    ...
    //    {
    //        super(zone, aLocale);
    //        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_UTIL_CALENDAR, this, "<init>",
    //                "(Ljava/util/TimeZone;Ljava/util/Locale;)V", new Object[] {zone, aLocale});
    //        FieldRegistry.register(this);
    //        Capturer.enable(Instrumenter.CAPTURE_ID_JAVA_UTIL_CALENDAR, this, CaptureLog.RETURN_TYPE_VOID);
    //    }

    /**
     * Static wrapper for getInstance with TimeZone.
     *
    ...
    /**
     * Static wrapper for getInstance with Locale.
     *
    ...
    /**
     * Static wrapper for getInstance with TimeZone and Locale.
     *
     * @param zone the time zone
     * @param locale the locale
     * @return a new Calendar instance
    ...
    public int getFirstDayOfWeek() {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_UTIL_CALENDAR, this, "getFirstDayOfWeek", "()I",
                new Object[]{});
    ...
    public void add(int field, int amount) {
        Capturer.capture(Instrumenter.CAPTURE_ID_JAVA_UTIL_CALENDAR, this, "add", "(II)V",
                new Object[]{field, amount});
