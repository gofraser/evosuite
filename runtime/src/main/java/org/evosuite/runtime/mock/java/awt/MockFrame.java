...
/**
 * OverrideMock for {@link java.awt.Frame}.  When a SUT class directly extends
 * {@code Frame}, bytecode instrumentation replaces the superclass with this
 ...
 * is created or shown.
 */
public class MockFrame extends Frame implements OverrideMock {

    private static final long serialVersionUID = 7261950923664173573L;
    ...
    // ── constructors (mirror every public Frame constructor) ────────
