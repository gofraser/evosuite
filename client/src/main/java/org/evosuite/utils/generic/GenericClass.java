 ...
 *
 * <p>All instantiate of this interface should be generated by {@code GenericClassFactory}
...
public interface GenericClass<T extends GenericClass<T>> extends Serializable {
     ...
     *
     * <p>If the generic class is not an array, its behaviour is undefined.
     *
     ...
     *
     * <p>The generic depth is assumed to be 0, e.g. this generic class is not
     * used as parameter of another generic class.
     *
     * <p>If this generic class has no wildcards or type variables, a copy of this generic class is returned.
     *
     ...
     * Generate a possible instantiation of this generic class randomly.
     *
     * <p>The current generic depth of the instantiation can be set with {@param recursionLevel} to ensure the
     ...
     *
     * <p>IF this is not a parameterized type, its behaviour is undefined.
     *
     ...
     *
     * <p>The order of the list is equal to the order of the generic parameters (from left to right).
     *
     ...
     *
     * <p>The generic information of the super class is inferred from this generic class.
     *
     * <p>See {@link GenericTypeReflector#getExactSuperType} for additional information.
     *
     ...
     *
     * <p>The key set of the mapping is the set of type variables of this generic class.
     ...
     *
     * <p>An example implementation on type level is: {@link GenericTypeReflector#addWildcardParameters(Class)}
     ...
     * or wildcards.
     *
     * <p>For inner classes, the type parameters and wildcards of the owner type
     * are also considered.
     *
     * <p>If the represented generic class is a array type,
     ...
     *
     * <p>If this generic class is a parameterized type,
     * all parameter types are checked recursively for type variables.
     *
     * <p>E.g. A&lt;B&lt;T&gt;&gt; returns true, if T is a type variable.
     *
    ...
    /**
     * Checks if this generic class is abstract.
     *
    ...
    /**
     * Checks if this generic class is anonymous.
     *
    ...
    /**
     * Checks if this generic class is an array.
     *
     ...
     *
     * <p>Every entry of {@param typeNap} is an constraint that enforces the key/type variable
     ...
     */
    GenericClass<?> getGenericWildcardInstantiation(Map<TypeVariable<?>, Type> typeMap,
