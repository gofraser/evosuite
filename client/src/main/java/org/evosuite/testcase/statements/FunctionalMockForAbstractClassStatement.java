...
public class FunctionalMockForAbstractClassStatement extends FunctionalMockStatement {
    ...
    public FunctionalMockForAbstractClassStatement(TestCase tc, VariableReference retval, GenericClass<?> targetClass)
            throws IllegalArgumentException {
        super(tc, retval, targetClass);
    }

    public FunctionalMockForAbstractClassStatement(TestCase tc, Type retvalType, GenericClass<?> targetClass)
            throws IllegalArgumentException {
