 ...
 *
 * <p>A typical example is "final" methods.
 *
 * <p>These methods will be handled like they were static
 * replacement ones: ie, same method name, but static, and
 * with class instance as first input parameter.
 *
 * <p>Note: such tag cannot be used in unspecialized EvoSuiteMocks,
 ...
 * not be accessible).
 *
 * <p>WARNING: should only be used on mocking _static_ methods.
 *
