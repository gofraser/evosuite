...
public class FieldReference extends VariableReferenceImpl {
    ...
    public FieldReference(TestCase testCase, GenericField field, VariableReference source) {
        ...
        assert (source != null || field.isStatic()) : "No source object was supplied, "
                + "therefore we assumed the field to be static. However asking the field "
                + "if it was static, returned false";
        this.field = field;
        this.source = source;
    }
    ...
    public FieldReference(TestCase testCase, GenericField field, Type fieldType,
        ...
        this.field = field;
        this.source = source;
        assert (source == null || field.getField().getDeclaringClass()
                .isAssignableFrom(source.getVariableClass()))
        ...
        try {
            ...
            if (source != null) {
                ...
                if (sourceObject == null) {
                     ...
                     *  and the testcase will execute in evosuite, executing it with junit will
                     *  however lead to a nullpointer exception
                     */
    ...
    public int getStPosition() {
        ...
        if (source != null) {
            ...
            throw new AssertionError(
                    "A VariableReference's position is only defined if the VariableReference "
                            + "is defined by a statement in the testCase.");
        }
    }
