...
public interface ExecutionTrace {
     ...
     *
     * @param branch         a int.
     * @param trueDistance  a double.
     * @param falseDistance a double.
     * @param bytecodeId    a int.
     */
    void branchPassed(int branch, int bytecodeId, double trueDistance, double falseDistance);
     ...
     * active MethodCall in this.stack.</p>
     *
     ...
     *
     * <p>Used for Definition-Use-Coverage-debugging.</p>
     *
    ...
    /**
     * Logs that a {@code <clinit>} was completed during this test execution.
     *
     * @param classNameWithDots the class name with dots.
     */
     ...
     * {@code <clinit>} method was finished during this test execution.
     *
     * @return .
     */
