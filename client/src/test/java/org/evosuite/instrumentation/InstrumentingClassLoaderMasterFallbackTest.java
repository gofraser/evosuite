...
public class InstrumentingClassLoaderMasterFallbackTest {
    ...
    @Test
    public void shouldFallbackToParentWhenMasterClassLoaderIsNotInitialized() throws Exception {
        MasterClassLoader.markMasterProcess();

        InstrumentingClassLoader loader = new InstrumentingClassLoader();
        Class<?> cls = loader.loadClass("java.lang.Integer");
