...
/**
 * Symbolic function for Long.valueOf.
 *
 * @author galeotti
 */
public final class J_ValueOf extends SymbolicFunction {
    ...
    public Object executeFunction() {
        ...
        ReferenceConstant symbLong = (ReferenceConstant) this.getSymbRetVal();
        Long concLong = (Long) this.getConcRetVal();
        env.heap.putField(Types.JAVA_LANG_LONG, SymbolicHeap.$LONG_VALUE,
                concLong, symbLong, intValue);
